...
%\author{Author A, Author B, and J. E. Smith\thanks{Corresponding author (\textit{E-mail address:} \texttt{xyz@math.univ.edu}).} }
...
\author{
  ...
  \and
  Author C\thanks{This author was supported in part by NSFC Grant No. 12345678.} \\
