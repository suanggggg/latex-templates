...
\documentclass[10pt,twoside,reqno,final]{article}
%\documentclass[10pt,reqno,draft]{article}
%\documentclass[a4pape,10pt,twoside]{article}
...
\title{Academic Article Template for Manuscript or Preprint\tfootnote{This is a title footnote}}
...
\author[1]{Author A}
\author[2]{Author B}
\author[1,\cormark]{Author C}
\affil[1]{Department of Mathematics, \LaTeX{} University}
\affil[2]{Department of Mechanical Engineering, \LaTeX{} University}
\cortext{Corresponding author. Email address: \texttt{xyz@math.univ.edu}}

% Short list of authors for running heads:
\shortauthor{Author A, Author B, and Author C}
...
\medskip
\noindent{\bfseries Keywords:} Academic article, Example, \LaTeX{} template

\medskip
\noindent{\bfseries Mathematics Subject Classification:} 65M60, 65M12.
\end{abstract}
...
\left\{\begin{aligned}
  ...
  & u(x,y,t) = g(t), \quad \text{on} ~ \partial \Omega \times \mathcal{T},, \\
  & u(x,y,0)=\varphi(x, y), \quad \text{on} ~\Omega,
\end{aligned}\right.
\end{equation}
where $\varepsilon$ is a small parameter.

This is an example of referencing the equation \eqref{eq:mulequ}.
...
Here we state our main result as \autoref{thm:bigthm}.
...
Some experimental results here. Some experimental results here.
Some experimental results here. Some experimental results here.
Some experimental results here.Some experimental results here.
...
\begin{figure}[htp!]
\centering
\subfloat[Subcaption A]{\includegraphics[width=0.46\linewidth]{fig1}}
\qquad
\subfloat[Subcaption B]{\includegraphics[width=0.46\linewidth]{fig2}}
